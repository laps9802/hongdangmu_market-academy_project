...
public class ReviewCompleteFragment extends Fragment {
    View view;
    RecyclerView recyclerView_reviewComplete;
    ...
    String URL = "http://192.168.0.69:8098/hongdangmu/purchase/list.do";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_review_complete, container, false);
        recyclerView_reviewComplete = view.findViewById(R.id.recyclerView_reviewComplete);

        linearLayoutManager = new LinearLayoutManager(getActivity());

        recyclerView_reviewComplete.setLayoutManager(linearLayoutManager);
        recyclerView_reviewComplete.setHasFixedSize(true);
...
//        client.post(Constants.ReviewCompleteFragmentURL, params, response);
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                for (int i=0; i<item.length(); i++) {
                    ...
                    Log.d("[INFO]", "lng = " + lng);
                    if (temp.getString("Preview_tf").equals("true")) {
                ...
                recyclerView_reviewComplete.setAdapter(adapter);
