...
public class BuyerReviewFragment extends Fragment {
    View view;
    RecyclerView recyclerView_buyer_review;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        client.post(Constants.BuyerReviewFragmentURL, params, response);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_buyer_review, container, false);
        textView_size = view.findViewById(R.id.textView_size);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView_buyer_review = view.findViewById(R.id.recyclerView_buyer_review);
        recyclerView_buyer_review.setLayoutManager(linearLayoutManager);
        recyclerView_buyer_review.setHasFixedSize(true);
    ...
    public class Response extends AsyncHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                recyclerView_buyer_review.setAdapter(adapter);
