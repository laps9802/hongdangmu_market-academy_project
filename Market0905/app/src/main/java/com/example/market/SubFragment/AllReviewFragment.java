...
public class AllReviewFragment extends Fragment {
    View view;
    RecyclerView recyclerView_all_review;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        client.post(Constants.AllReviewFragmentURL, params, response);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_all_review, container, false);
        textView_size = view.findViewById(R.id.textView_size);
        linearLayoutManager = new LinearLayoutManager(getActivity());
        recyclerView_all_review = view.findViewById(R.id.recyclerView_all_review);
        recyclerView_all_review.setLayoutManager(linearLayoutManager);
        recyclerView_all_review.setHasFixedSize(true);
    ...
    public class Response extends AsyncHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                recyclerView_all_review.setAdapter(adapter);
