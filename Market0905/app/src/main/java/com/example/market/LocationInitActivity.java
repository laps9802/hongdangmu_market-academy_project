...
public class LocationInitActivity extends AppCompatActivity implements View.OnClickListener {
    //전역, 상수
    private final String TAG = "LocInitActi-";

    //화면
    TextView locInit_text_gpsPlaceName;
    Button locInit_btn_ok, locInit_btn_updateLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_init);
        ...
        locInit_text_gpsPlaceName = findViewById(R.id.locInit_text_gpsPlaceName);
        locInit_btn_ok = findViewById(R.id.locInit_btn_ok);
        locInit_btn_updateLocation = findViewById(R.id.locInit_btn_updateLocation);

        client = new AsyncHttpClient();

        locInit_btn_ok.setOnClickListener(this);
        locInit_btn_updateLocation.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.locInit_btn_ok:
                ...
                break;
            case R.id.locInit_btn_updateLocation:
                locInit_text_gpsPlaceName.setText("");
                checkActivation();
                break;
        }
    }
...
//        }
        ...
        builder.setTitle("위치정보서비스(GPS) 설정")
                ...
                .setPositiveButton("설정하기", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        startActivityForResult(intent, Constants.LOCINIT_GPS_ACTIVATION);
                    }
                })
    ...
    private void convertToPlaceName(Location location) {
        ...
        client.get(Constants.reverseGeocoding_URL, params, new AsyncHttpResponseHandler() {           //네이버 - get만 받음
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    locInit_text_gpsPlaceName.setText(sido + " " + gu + " " + adm_area);
                    adminArea = adm_area;
