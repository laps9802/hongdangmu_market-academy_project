...
public class SellHideFragment extends Fragment implements RecyclerView.OnItemTouchListener {
    View view;
    RecyclerView recyclerView_sellHide;
...
//        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_sell_hide, container, false);
        recyclerView_sellHide = view.findViewById(R.id.recyclerView_sellHide);

        linearLayoutManager = new LinearLayoutManager(getActivity());

        recyclerView_sellHide.setLayoutManager(linearLayoutManager);
        recyclerView_sellHide.setHasFixedSize(true);
        recyclerView_sellHide.addOnItemTouchListener(this);
    ...
    private void getData() {
        ...
        client.post(Constants.SellHideFragmentURL, params, response);
    }
    ...
    public class Response extends AsyncHttpResponseHandler {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            ...
            try {
                ...
                recyclerView_sellHide.setAdapter(adapter);
